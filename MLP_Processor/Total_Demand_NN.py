...
Regressor = MLPRegressor(
    ...
    max_iter=4000,
    activation='relu',        # can handle continuous smooth signals better than ReLU sometimes
    solver='adam',
    learning_rate_init=0.004253303307632643, # slower, but often converges more reliably
    learning_rate='adaptive',
    alpha=00.0006208342600258237,   # default is 0.0001
...
# param_dist = {
#     'mlp__hidden_layer_sizes': [(20,20), (50,50), (50,50,20), (100,50), (20,20,20), (20,20,20,15),(20,20,20,20,15)],
...
pipeline_mlp.fit(X, y_shuffled)
print("R² shuffled:", pipeline_mlp.score(X, y_shuffled))
...
corrs = data[[f"lag_{i}" for i in range(1, 49)]].corrwith(data["TOTALDEMAND"])
plt.plot(range(1, 49), corrs)
